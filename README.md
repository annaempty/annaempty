...
<table>
    ...
    <tbody align="left">
        ...
        <tr>
            ...
            <td>Был проведен анализ поведения пользователей дейтинг приложения. Осуществлена проверка работы сплит-системы, выбор и расчет метрик (CTR, количество свайпов, количество метчей), реализованы следующие статистические тесты: Т-тест, Хи-квадрат</td>
